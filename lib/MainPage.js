...
const MainPage = ({ navigation }) => {
    return (
        <View style={{ flex: 1, flexDirection: 'column', backgroundColor: '#ffffff' }}>
            ...
            <Text style={{ flex: 0, fontSize: 42, textAlign: 'center', fontFamily: 'Times', color: "#63e0de", fontWeight: 'bold', paddingLeft: 15, paddingTop: 50 }}>Welcome</Text>
            ...
            <View style={{ flex: 0, flexDirection: 'row', justifyContent: 'center' }}>
                <TouchableOpacity activeOpacity={0.75} style={sty.TopRight} onPress={() => navigation.push('List')}>
                    <Image
            ...
            <View style={{ flex: 0, flexDirection: 'row', justifyContent: 'center' }}>
                <TouchableOpacity style={sty.BottomLeft} onPress={()=>{navigation.push('')}}>
                    <Image
                ...
                <TouchableOpacity style={sty.BottomRight} onPress={()=>{'About'}}>
                    <Image
